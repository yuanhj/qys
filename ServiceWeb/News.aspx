                    ...
                    <div class="table_lie">
                        <ul>
                            <asp:Repeater ID="rpt_Newslist" runat="server">
                                <ItemTemplate>
                                    <li><a href="PostDetail.aspx?id=<%#Eval("ID") %>"><span class="lie_240"><%#CountyName( Eval("CountyID").ToString()) %></span><span class="lie_420"><%#Eval("Subject").ToString().Length>25?Eval("Subject").ToString().Substring(0,25):Eval("Subject").ToString() %></span><span class="lie_99" style="text-align:center;width:260px;"><%#string.Format("{0:d}",Eval("AddTime")) %></span></a></li>
                                </ItemTemplate>
                            </asp:Repeater>
                        </ul>
                    </div>
