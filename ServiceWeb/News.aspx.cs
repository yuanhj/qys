...
{
    public partial class News : Web.RequestBase
    {
        ...
        public void Binds()
        {
            string Sql = "select * from Post where CountyID=" + CountyID + " and Subject not in('服务机构','诉求办理流程','服务政策') and Status>-1 and TypeID=1  order by ID desc";
        ...
        public string CountyName(string cid)
        {
